...
:: Android packaging
set AND_CERT_NAME="CowFallOrigin"
set AND_CERT_PASS=SpL12345!
set AND_CERT_FILE=cert\CowFallOrigin.p12
...
set IOS_PROVISION=cert\CowFallOrigin.mobileprovision
